...
<%@ include file="/WEB-INF/view/mainCafeTop.jsp" %>
	<div class="container">
		<div class="page-header">
			<h1>
				Q&A 등록 <small>CAFE HEAVEN</small>
			</h1>
		</div>
		<form class="form-horizontal" method="post" action="/notice/questionRegProc.do">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<textarea class="form-control" rows="10" name="ntCont" placeholder="내용을 입력하세요."></textarea>
				</div>
			</div>
			<!--  하든으로 보낼것 -->
			...
			<div class="form-group">
				<div class="col-sm-12 text-center">
					<button class="btn btn-success" name="ntReg" type="submit" style="min-width:25%">
						...
						<a href="/notice/communityTab.do" class="btn btn-danger" style="min-width:25%;"><i class="fa fa-times spaceLeft"></i>취소
					</a>
				</div>
			</div>
		</form>	
