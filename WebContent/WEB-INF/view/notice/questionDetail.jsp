...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h1>
				Q&A 세부보기 <small>CAFE HEAVEN</small>
			</h1>
		</div>
		<div class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input class="form-control" name="ntTitle" type="text" value="<%=CmmUtil.nvl(nDTO.getNtTitle())%>" readonly >
				</div>
			</div>
			<!-- 작성자 -->
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input class="form-control" name="ntWriter" type="text" value="<%=CmmUtil.nvl(nDTO.getNtWriter())%>" readonly >
				</div>
			</div>
			<!-- 작성일 -->
			...
			<div class="form-group">
				...
				<% if (userNo.equals("1")) {%>
					<button class="btn btn-success" onclick="ansChk();" id="ansChk" style="min-width:25%;">
						<i class="fa fa-check spaceLeft"></i>답글
					</button>
					<button class="btn btn-danger" onclick="noticeDelete('<%=nDTO.getNtNo()%>');" style="min-width:25%;">
			...
			<%-- 	<a href="/notice/noticeUpdateView.do?regNo=<%=nDTO.getRegNo()%>&ntNo=<%=nDTO.getNtNo()%>" class="btn btn-success">
				...
				<% if(userNo.equals(nDTO.getRegNo())&&!userNo.equals("1")) { %>
					<a href="/notice/noticeUpdateView.do?regNo=<%=nDTO.getRegNo()%>&ntNo=<%=nDTO.getNtNo()%>" class="btn btn-success" style="min-width:25%;">
						<i class="fa fa-check spaceLeft"></i>수정
					</a>
					<button class="btn btn-danger" onclick="noticeDelete('<%=nDTO.getNtNo()%>');" style="min-width:25%;">
						<i class="fa fa-times spaceLeft "></i>삭제
					</button>
