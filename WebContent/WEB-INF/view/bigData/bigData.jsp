	...
	<div class="container">
		...
		<div class="tab-content">
			...
			<div id="bd-menu1" class="tab-pane in active">
				...
				<!-- 지역 분석 목록리스트 -->
				<!-- 지역별 선택ㄷ -->
				<div id="hdshone" style="width: 50%; float: left;"
					class="regButton btn-5 taCp">카페 분포 지도</div>
				<div id="hdshtwo" style="width: 50%; float: left;"
					class="regButton btn-5 taCp">지역 상권 밀집도</div>
				<div id="regionTypeBs">
					<!-- 카페 분포로 바꿈 차트   , 텍스트보여줄곳 -->
					<div id="showChart">
						<div class="col-sm-12">
							<div style="margin: auto; width: 33%;"
								class="regButton btn-5 taCp" id="clusterChart">검색</div>
						</div>
					</div>
				</div>
				...
				<div id="myRegionSameBs">
					<!-- 내 지역 같은 업종 분포 및 좌표 -->
					<div id="searchResult">검색해주세요!!</div>
					...
					<div class="col-sm-9">
						<div class="form-group">
							...
							</select> <select class="col-sm-4 form-control" name="gugun">
							</select> <select class="col-sm-4 form-control" name="dong">
							</select>
						</div>
					</div>
					...
					<div class="col-sm-9">
						<div class="form-group">
							...
							</select> <select class="col-sm-4 form-control" name="midBusiness">
							</select> <select class="col-sm-4 form-control" name="smallBusiness">
							</select>
						</div>
					</div>
					...
					<input type="hidden" id="sidoVal" value="" /> <input type="hidden"
						id="gugunVal" value="" /> <input type="hidden" id="dongVal"
						value="" /> <input type="hidden" id="radiusVal" value="" /> <input
						type="hidden" id="bigVal" value="" /> <input type="hidden"
						id="midVal" value="" /> <input type="hidden" id="smallVal"
						value="" />

					<!-- 카페 분포에서 받은 값 -->
					<input type="hidden" id="sidoMapVal" value="" /> <input
						type="hidden" id="gugunMapVal" value="" /> <input type="hidden"
						id="dongMapVal" value="" />
					...
					<div class="col-sm-12" id="mapChg">
						<div style="margin: auto; width: 33%" class="regButton btn-5 taCp">조건
							검색</div>
					</div>
