...
<div class="navbar navbar-default navbar-top affix-top" role="navigation" data-spy="affix" data-offset-top="50">
<div class="container">
...
<li>
<a href="/cafe/cafeInfo.do?cafeNo=1">
 카페정보
</a>
</li>
<!-- 관리자 -->
...
<li><a onclick="logout();"><img src="/assets/img/logout.png"  style="width:50px ;height:auto; cursor:pointer;"  /></a></li>
<li><a href="/user/userMypage.do?userNo=<%=userNo%>" class="btn"><img src="/assets/img/mypage.png" style="width:50px ;height:auto" /></a></li>
<li><a href="/tmpBasket/tmpBasketList.do?userNo=<%=userNo%>" class="btn"><img src="/assets/img/basket.png" style="width:50px ;height:auto" /></a></li>
<%} %>
</ul>
</div>
</div>
